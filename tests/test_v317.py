...
class TestTickOrdering:
    ...
    def test_scheduler_child_autonomy_before_auto_reproduce(self):
        ...
        class FakeOrganism:
            ...
            def wake_dormant_cycle(self): calls.append("wake_dormant_cycle")
            def stability_reproduction_cycle(self): calls.append("stability_reproduction_cycle")
            def lone_survivor_reproduction(self): calls.append("lone_survivor_reproduction")
